...
export default function OurAwards() {
  return (
    <section className={`py-24 ${styles.section}`}>
      <div className="md:flex justify-between items-center xl:px-24 p-4" data-aos="fade-right">
      ...
      <div className="flex flex-wrap gap-8 justify-evenly items-center mt-12">
        <div className="bg-white border group p-14 relative" data-aos="fade-up" data-aos-delay="400">
          <Image
            src={Bosch}
            alt="Bosch"
